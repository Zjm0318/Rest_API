...
namespace IOT_Rest_BLL
{
    public class OrderBLL
    {
        ...
        public int AddOrder(tb_Order orders, List<tb_Menu> m)
        {
            ...
            string sql = $"insert into tb_order(Order_Num,User_Id,Desk_Id,Order_Price,Order_State,Order_fs,Order_Sate,Order_Dan) VALUES('{Number}','{orders.User_Id}','1','{orders.Order_Price}','0','微信','{DateTime.Now}','{orders.Order_Dan}')";
